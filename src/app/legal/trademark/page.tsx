...
export const metadata = createLegalMetadata({
  ...
  description: 'Trademark usage guidelines and brand asset boundaries for Mini Post App.',
  path: '/legal/trademark',
});

export default function TrademarkPage() {
  const doc = getLegalDocumentBySlug('trademark');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/trademark' }]}
    >
