...
export const metadata = createLegalMetadata({
  ...
  description: 'Responsible AI principles, human oversight, safety guardrails, and transparency in prompt engineering.',
  path: '/legal/responsible-ai',
});

export default function ResponsibleAiPage() {
  const doc = getLegalDocumentBySlug('responsible-ai');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/responsible-ai' }]}
    >
