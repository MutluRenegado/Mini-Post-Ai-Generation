...
export const metadata = createLegalMetadata({
  ...
  description: 'Copyright ownership guidelines, DMCA notice procedures, and copyright reporting routes for Mini Post App.',
  path: '/legal/copyright',
});

export default function CopyrightPage() {
  const doc = getLegalDocumentBySlug('copyright');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/copyright' }]}
    >
