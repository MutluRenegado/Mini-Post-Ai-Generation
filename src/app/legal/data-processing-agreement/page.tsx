...
export const metadata = createLegalMetadata({
  ...
  description: 'Standard Data Processing Addendum for business and enterprise customers using Mini Post App.',
  path: '/legal/data-processing-agreement',
});

export default function DpaPage() {
  const doc = getLegalDocumentBySlug('data-processing-agreement');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/data-processing-agreement' }]}
    >
