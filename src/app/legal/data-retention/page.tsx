...
export const metadata = createLegalMetadata({
  ...
  description: 'Operational rules governing account record storage, OAuth token lifecycles, and deletion purge schedules.',
  path: '/legal/data-retention',
});

export default function DataRetentionPage() {
  const doc = getLegalDocumentBySlug('data-retention');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/data-retention' }]}
    >
