...
export const metadata = createLegalMetadata({
  ...
  description: 'Rules governing acceptable platform conduct and prohibited content categories for Mini Post App.',
...
export default function AcceptableUsePage() {
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/acceptable-use' }]}
    >
