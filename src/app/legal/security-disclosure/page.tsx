...
export const metadata = createLegalMetadata({
  ...
  description: 'Technical security controls, AES-256 token encryption, TLS 1.3, and vulnerability reporting.',
  path: '/legal/security-disclosure',
});

export default function SecurityDisclosurePage() {
  const doc = getLegalDocumentBySlug('security-disclosure');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/security-disclosure' }]}
    >
