...
export const metadata = createLegalMetadata({
  ...
  description: 'Accessibility Statement and WCAG 2.2 AA alignment commitments for Mini Post App.',
  path: '/legal/accessibility',
});

export default function AccessibilityPage() {
  const doc = getLegalDocumentBySlug('accessibility');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/accessibility' }]}
    >
