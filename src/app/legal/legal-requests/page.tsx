...
export const metadata = createLegalMetadata({
  ...
  description: 'Submission guidelines for privacy requests, copyright notices, and legal inquiries.',
  path: '/legal/legal-requests',
});

export default function LegalRequestsPage() {
  const doc = getLegalDocumentBySlug('legal-requests');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/legal-requests' }]}
    >
