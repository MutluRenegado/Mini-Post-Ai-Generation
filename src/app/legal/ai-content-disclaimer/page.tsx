...
export const metadata = createLegalMetadata({
  ...
  description: 'Disclosures regarding AI text & image generation and mandatory user review requirements.',
  path: '/legal/ai-content-disclaimer',
});

export default function AiContentDisclaimerPage() {
  const doc = getLegalDocumentBySlug('ai-content-disclaimer');
  if (!doc) notFound();
  ...
  return (
    <LegalPageShell
      ...
      breadcrumbs={[{ label: doc.title, href: '/legal/ai-content-disclaimer' }]}
    >
