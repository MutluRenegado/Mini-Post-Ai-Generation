...
7. Focus exclusively on article and post text generation. Image prompts are strictly derived downstream from your final approved text via ContentSummarizer.
